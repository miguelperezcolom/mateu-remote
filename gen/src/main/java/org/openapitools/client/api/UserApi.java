...
public class UserApi {
    ...
    public UserProfileDto getUserProfile(String id) throws ApiException {
        ApiResponse<UserProfileDto> localVarResp = getUserProfileWithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     */
    public okhttp3.Call getUserProfileAsync(String id, final ApiCallback<UserProfileDto> _callback) throws ApiException {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 404 </td><td> User cannot be found. See the [Introduction](https://docs.camunda.org/manual/7.18/reference/rest/overview/#error-handling) for the error response format. </td><td>  -  </td></tr>
     </table>
     */
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 500 </td><td> The user could not be updated due to an internal server error. See the [Introduction](https://docs.camunda.org/manual/7.18/reference/rest/overview/#error-handling) for the error response format. </td><td>  -  </td></tr>
     </table>
     */
     ...
     */
    public okhttp3.Call updateCredentialsAsync(String id, UserCredentialsDto userCredentialsDto, final ApiCallback<Void> _callback) throws ApiException {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 204 </td><td> Request successful. This method returns no content. </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Identity service is read-only (Cannot modify users / groups / memberships). </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> If the user with the requested Id cannot be found. </td><td>  -  </td></tr>
        <tr><td> 500 </td><td> The user could not be updated due to an internal server error. See the [Introduction](https://docs.camunda.org/manual/7.18/reference/rest/overview/#error-handling) for the error response format. </td><td>  -  </td></tr>
     </table>
     */
     ...
     */
    public okhttp3.Call updateProfileAsync(String id, UserProfileDto userProfileDto, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateProfileValidateBeforeCall(id, userProfileDto, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
