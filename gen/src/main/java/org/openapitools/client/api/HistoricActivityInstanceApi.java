...
import org.openapitools.client.model.HistoricActivityInstanceDto;
import org.openapitools.client.model.HistoricActivityInstanceQueryDto;
...
public class HistoricActivityInstanceApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 404 </td><td> Not Found Historic activity instance with given id does not exist. See the [Introduction](https://docs.camunda.org/manual/7.18/reference/rest/overview/#error-handling) for the error response format. </td><td>  -  </td></tr>
     </table>
     */
