...
public class ProcessInstanceApiTest {
     ...
     */
    @Test
    public void correlateMessageAsyncOperationTest() throws ApiException {
     ...
     */
    @Test
    public void getProcessInstanceCommentsTest() throws ApiException {
        String id = null;
        List<CommentDto> response = api.getProcessInstanceComments(id);
